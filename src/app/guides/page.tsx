...
export default function GuidesIndexPage() {
  ...
  return (
    <div className="bg-white min-h-screen">
      {/* Hero */}
      <section className="bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700 py-12 md:py-20">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-base md:text-lg lg:text-xl text-emerald-100 max-w-2xl mx-auto leading-relaxed">
